...
export const SupabaseMobileService = {
  // ============================================================================
  // MOVEMENTS
  // ============================================================================
  async getMovements(): Promise<Movement[]> {
    ...
    try {
      ...
      if (error) {
        console.error('[SupabaseMobileService] Erro ao buscar movimentações:', error.message);
        return [];
      }
      ...
      console.error('[SupabaseMobileService] Exceção em getMovements:', e);
      return [];
    }
  },
  ...
  async addMovement(movement: Omit<Movement, 'id'>): Promise<Movement | null> {
    ...
    try {
      ...
      if (error) {
        console.error('[SupabaseMobileService] Erro ao criar movimentação:', error.message);
        return null;
      }
      ...
      console.error('[SupabaseMobileService] Exceção em addMovement:', e);
      return null;
    }
  },
  ...
  async updateMovement(id: string, updates: Partial<Movement>): Promise<boolean> {
    ...
    try {
      ...
      if (error) {
        console.error('[SupabaseMobileService] Erro ao atualizar movimentação:', error.message);
        return false;
      }
      return true;
    } catch (e) {
      console.error('[SupabaseMobileService] Exceção em updateMovement:', e);
      return false;
    }
  },
  ...
  async deleteMovement(id: string): Promise<boolean> {
    ...
    try {
      ...
      if (error) {
        console.error('[SupabaseMobileService] Erro ao deletar movimentação:', error.message);
        return false;
      }
      return true;
    } catch (e) {
      console.error('[SupabaseMobileService] Exceção em deleteMovement:', e);
      return false;
    }
  },
  ...
  async getNatures(): Promise<ExpenseNature[]> {
    ...
    try {
      ...
      if (error) {
        console.error('[SupabaseMobileService] Erro ao buscar naturezas:', error.message);
        return [];
      }
      ...
      console.error('[SupabaseMobileService] Exceção em getNatures:', e);
      return [];
    }
  },
  ...
  async addNature(nature: ExpenseNature): Promise<ExpenseNature | null> {
    ...
    try {
      ...
      if (error) {
        console.error('[SupabaseMobileService] Erro ao salvar natureza:', error.message);
        return null;
      }
      ...
      console.error('[SupabaseMobileService] Exceção em addNature:', e);
      return null;
    }
  },
  ...
  async updateNature(id: string, updates: Partial<ExpenseNature>): Promise<boolean> {
    ...
    try {
      ...
      if (error) {
        console.error('[SupabaseMobileService] Erro ao atualizar natureza:', error.message);
        return false;
      }
      return true;
    } catch (e) {
      console.error('[SupabaseMobileService] Exceção em updateNature:', e);
      return false;
    }
  },
  ...
  async deleteNature(id: string): Promise<boolean> {
    ...
    try {
      ...
      if (error) {
        console.error('[SupabaseMobileService] Erro ao excluir natureza:', error.message);
        return false;
      }
      return true;
    } catch (e) {
      console.error('[SupabaseMobileService] Exceção em deleteNature:', e);
      return false;
    }
  },
  ...
  async getGoals(): Promise<Goal[]> {
    ...
    try {
      ...
      if (error) {
        console.error('[SupabaseMobileService] Erro ao buscar metas:', error.message);
        return [];
      }
      ...
      console.error('[SupabaseMobileService] Exceção em getGoals:', e);
      return [];
    }
  },
  ...
  async addGoal(goal: Omit<Goal, 'id'>): Promise<Goal | null> {
    ...
    try {
      ...
      if (error) {
        console.error('[SupabaseMobileService] Erro ao inserir meta:', error.message);
        return null;
      }
      ...
      console.error('[SupabaseMobileService] Exceção em addGoal:', e);
      return null;
    }
  },
  ...
  async updateGoal(id: string, updates: Partial<Goal>): Promise<boolean> {
    ...
    try {
      ...
      if (error) {
        console.error('[SupabaseMobileService] Erro ao atualizar meta:', error.message);
        return false;
      }
      return true;
    } catch (e) {
      console.error('[SupabaseMobileService] Exceção em updateGoal:', e);
      return false;
    }
  },
  ...
  async deleteGoal(id: string): Promise<boolean> {
    ...
    try {
      ...
      if (error) {
        console.error('[SupabaseMobileService] Erro ao deletar meta:', error.message);
        return false;
      }
      return true;
    } catch (e) {
      console.error('[SupabaseMobileService] Exceção em deleteGoal:', e);
      return false;
    }
  },
  ...
  async getAccounts(): Promise<BankAccount[]> {
    ...
    try {
      ...
      if (error) {
        console.error('[SupabaseMobileService] Erro ao buscar contas:', error.message);
        return [];
      }
      ...
      console.error('[SupabaseMobileService] Exceção em getAccounts:', e);
      return [];
    }
  },
  ...
  async upsertAccount(account: BankAccount): Promise<boolean> {
    ...
    try {
      ...
      const { error } = await supabase.from(TABLES.ACCOUNTS).upsert(payload);
      return !error;
    } catch (e) {
      console.error('[SupabaseMobileService] Exceção em upsertAccount:', e);
      return false;
    }
  },
  ...
  async getCheckpoints(): Promise<FinancialCheckpoint[]> {
    ...
    try {
      ...
      if (error) {
        console.error('[SupabaseMobileService] Erro ao buscar checkpoints:', error.message);
        return [];
      }
      ...
      console.error('[SupabaseMobileService] Exceção em getCheckpoints:', e);
      return [];
    }
  },
  ...
  async upsertCheckpoint(cp: FinancialCheckpoint): Promise<boolean> {
    ...
    try {
      ...
      const { error } = await supabase.from(TABLES.CHECKPOINTS).upsert(payload);
      return !error;
    } catch (e) {
  ...
  async deleteAccount(id: string): Promise<boolean> {
    if (!isSupabaseConfigured) return false;
    try {
      const { error } = await supabase.from(TABLES.ACCOUNTS).delete().eq('id', id);
      return !error;
    } catch {
      return false;
    }
  ...
  async deleteCheckpoint(id: string): Promise<boolean> {
    if (!isSupabaseConfigured) return false;
    try {
      const { error } = await supabase.from(TABLES.CHECKPOINTS).delete().eq('id', id);
      return !error;
    } catch {
      return false;
    }
  ...
  async getPaymentMethods(): Promise<PaymentMethodItem[]> {
    if (!isSupabaseConfigured) return [];
    try {
      const { data, error } = await supabase.from(TABLES.PAYMENT_METHODS).select('*');
      if (error) return [];
      return (data || []).map((row: any) => ({
        id: String(row.id),
        name: row.name,
        ...
        closingDay: row.closing_day ? Number(row.closing_day) : undefined,
